  ...
  return (
    <main className="flex-1 p-6 md:p-10 space-y-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Trust Levels */}
        <div className="lg:col-span-1 bg-white/75 backdrop-blur-xl p-8 rounded-lg shadow-sm border border-white/20 space-y-6">
          <h2 className="text-2xl font-bold tracking-tight">Cấp bậc uy tín</h2>
          <div className="space-y-4">
            <div className="flex items-center gap-4 p-4 rounded-2xl bg-[#eff0f7] transition-all hover:bg-[#e0e2ea]">
              <div className="w-12 h-12 rounded-xl bg-amber-100 text-amber-600 flex items-center justify-center">
                <span className="material-symbols-outlined" style={{fontVariationSettings: "'FILL' 1"}}>workspace_premium</span>
              </div>
              <div>
                <p className="font-bold">Kim Cương</p>
                <p className="text-xs text-[#595b61]">900 - 1000 điểm</p>
              </div>
              <span className="material-symbols-outlined ml-auto text-slate-300">lock</span>
            </div>
            {/* Active Level */}
            ...
            <div className="flex items-center gap-4 p-4 rounded-2xl bg-[#eff0f7] opacity-60">
              ...
              <div>
                ...
                <p className="text-xs text-[#595b61]">400 - 699 điểm</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-white/75 backdrop-blur-xl p-8 rounded-lg shadow-sm border border-white/20">
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-6 items-start">
                ...
                <div className="flex-1 pb-6 border-b border-slate-100">
                  ...
                  <p className="text-[#595b61] text-sm mb-2">Đã bàn giao tài sản cho người sở hữu thành công tại Quận 1, TP.HCM.</p>
                  <span className="text-xs text-slate-400">2 ngày trước • Xác thực bởi hệ thống</span>
                </div>
              </div>
              ...
              <div className="flex gap-6 items-start">
                ...
                <div className="flex-1 pb-6 border-b border-slate-100">
                  ...
                  <p className="text-[#595b61] text-sm mb-2">Hoàn tất quy trình KYC và liên kết tài khoản ngân hàng chính chủ.</p>
              ...
              <div className="flex gap-6 items-start">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-[#595b61] text-sm mb-2">&quot;Rất nhiệt tình và trung thực, cảm ơn bạn nhiều!&quot; - Minh Anh.</p>
                  <span className="text-xs text-slate-400">2 tuần trước</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="space-y-6">
        <h2 className="text-3xl font-black tracking-tighter text-indigo-900">Danh hiệu đạt được</h2>
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6">
          <div className="bg-white/75 backdrop-blur-xl p-6 rounded-lg text-center space-y-4 group transition-all hover:-translate-y-2 shadow-sm border border-white/20">
            <div className="w-20 h-20 mx-auto rounded-full bg-gradient-to-tr from-indigo-500 to-indigo-300 p-1">
              <div className="w-full h-full rounded-full bg-white flex items-center justify-center text-indigo-500">
            ...
            <div>
              ...
              <p className="text-[10px] text-slate-400 uppercase tracking-widest font-bold">Lvl. 3</p>
            </div>
          </div>
          <div className="bg-white/75 backdrop-blur-xl p-6 rounded-lg text-center space-y-4 group transition-all hover:-translate-y-2 shadow-sm border border-white/20">
            ...
            <div>
              ...
              <p className="text-[10px] text-slate-400 uppercase tracking-widest font-bold">Lvl. 1</p>
            </div>
          </div>
          <div className="bg-white/75 backdrop-blur-xl p-6 rounded-lg text-center space-y-4 group transition-all hover:-translate-y-2 shadow-sm border border-white/20">
            <div className="w-20 h-20 mx-auto rounded-full bg-gradient-to-tr from-emerald-500 to-emerald-300 p-1">
              <div className="w-full h-full rounded-full bg-white flex items-center justify-center text-emerald-500">
            ...
            <div>
              ...
              <p className="text-[10px] text-slate-400 uppercase tracking-widest font-bold">Lvl. 5</p>
            </div>
          </div>
          {/* Locked */}
          <div className="bg-white/75 backdrop-blur-xl p-6 rounded-lg text-center space-y-4 opacity-40 grayscale transition-all hover:grayscale-0 shadow-sm border border-white/20">
            ...
            <div>
              ...
              <p className="text-[10px] text-slate-400 uppercase tracking-widest font-bold">Locked</p>
            </div>
          </div>
        </div>
      </section>
